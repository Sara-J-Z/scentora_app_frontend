...
//         <button onClick={() => navigate("/profile/password-update")}>
//           Update Password
//         </button>
//       </div>
//     </div>
...
import { useState, useEffect } from "react";
import { ProfileData } from "../services/profile"; // This service call will be skipped
import { useNavigate } from "react-router-dom";
import "../style/ProfilePage.css";

// This is a mock data object to display the profile page layout
// since the real data is not available without a user logged in.
